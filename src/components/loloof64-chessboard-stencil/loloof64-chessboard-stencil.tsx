...
export class Loloof64ChessboardStencil {
  ...
  */
  ...
  render() {
    ...
    if (whitePawnDragged) draggedImage = getAssetPath('/chess_vectors/Chess_plt45.svg');
    if (whiteKnightDragged) draggedImage = getAssetPath('/chess_vectors/Chess_nlt45.svg');
    if (whiteBishopDragged) draggedImage = getAssetPath('/chess_vectors/Chess_blt45.svg');
    if (whiteRookDragged) draggedImage = getAssetPath('/chess_vectors/Chess_rlt45.svg');
    if (whiteQueenDragged) draggedImage = getAssetPath('/chess_vectors/Chess_qlt45.svg');
    if (whiteKingDragged) draggedImage = getAssetPath('/chess_vectors/Chess_klt45.svg');
    if (blackPawnDragged) draggedImage = getAssetPath('/chess_vectors/Chess_pdt45.svg');
    if (blackKnightDragged) draggedImage = getAssetPath('/chess_vectors/Chess_ndt45.svg');
    if (blackBishopDragged) draggedImage = getAssetPath('/chess_vectors/Chess_bdt45.svg');
    if (blackRookDragged) draggedImage = getAssetPath('/chess_vectors/Chess_rdt45.svg');
    if (blackQueenDragged) draggedImage = getAssetPath('/chess_vectors/Chess_qdt45.svg');
    if (blackKingDragged) draggedImage = getAssetPath('/chess_vectors/Chess_kdt45.svg');
    ...
    const promotionKnight = this.logicalBoard.turn() === 'w' ? getAssetPath('/chess_vectors/Chess_nlt45.svg') : getAssetPath('/chess_vectors/Chess_ndt45.svg');
    const promotionBishop = this.logicalBoard.turn() === 'w' ? getAssetPath('/chess_vectors/Chess_blt45.svg') : getAssetPath('/chess_vectors/Chess_bdt45.svg');
    const promotionRook = this.logicalBoard.turn() === 'w' ? getAssetPath('/chess_vectors/Chess_rlt45.svg') : getAssetPath('/chess_vectors/Chess_rdt45.svg');
    const promotionQueen = this.logicalBoard.turn() === 'w' ? getAssetPath('/chess_vectors/Chess_qlt45.svg') : getAssetPath('/chess_vectors/Chess_qdt45.svg');
